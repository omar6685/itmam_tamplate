...
const translations = {
  en: {
    ...
    employees1: "1 - 30 employees",
    employees2: "31 - 100 employees",
    employees3: "101 - 200 employees",
    bs1: "Browse services",
    bs2: "Browse services",
    bs3: "Browse services",
    workingProcedure: "Working Procedure",
    q1: "How is coordination done?",
    a1: "Coordinate with the employer or the responsible employee in the establishment to agree on how to manage government platforms and their operations.",
    q2: "How is delegation carried out?",
    a2: "Access is delegated to some platforms that can be authorized. For platforms that cannot be delegated, communication with the person in charge at the establishment is made to provide us with the codes when accessing these platforms.",
    q3: "What's next?",
    a3: "Determine the work mechanism and follow up with the employer or Human Resources department to identify the best communication methods preferred by the client, such as (emails - WhatsApp - phone calls - task organization programs like Trello, To Do, Keep, or others). Also, determine the method of archiving operations for the client to refer back to at any time, whether in Google Drive, OneDrive, or emails.",
    featuresAndGuarantees: "Features and Guarantees",
    feature1: "Each establishment has a dedicated account manager who executes daily operations, communicates with the employer, and provides periodic reports.",
    feature2: "Over 10 years of experience in managing government operations for establishments and understanding of regulations and bylaws.",
    feature3: "We work as part of your organization and as a highly experienced employee within your team.",
    feature4: "We guarantee to bear the cost of any violation or fine that we are responsible for causing.",
    feature5: "Smooth integration and collaboration with the employer and the Human Resources management team.",
  ...
  ar: {
    ...
    contact: "تواصل معنا",
    slugain: "أدر أعمالك",
    slugain2: "شركة سعودية حديثة التأسيس لمواكبة التغيرات السريعة والتطور السريع في مجال الحكومة الإلكترونية حيث تمتلك إتمام العربية فريق من الخبراء في مجال علاقات الحكومة الإلكترونية والعاملين في الميدان بكفاءة عالية بالإضافة إلى وجود كوادر متخصصة في المواد البشرية.",
    button1: "الخدمات والباقات",
    why: "لماذا تختارنا؟",
    experts: "خبراء",
    experts2: "خبراء في مجال إدراة العلاقات الحكومية",
    quality: "جودة",
    quality2: "جودة الأداء وسرعة العمل",
    consulting: "استشارات",
    consulting2: "تقديم الاستشارات والدراسات التحليلية",
    ...
    employees1: "1 - 30 موظف",
    employees2: "31 - 100 موظف",
    employees3: "101 - 200 موظف",
    bs1: "اطلع على الخدمات",
    bs2: "اطلع على الخدمات",
    bs3: "اطلع على الخدمات",
    workingProcedure: "آلية العمل",
    q1: "كيف يتم التنسيق؟",
    a1: "التنسيق مع صاحب العمل أو الموظف المسؤول في المنشأة للاتفاق على كيفية إدارة المنصات الحكومية وعملياتها.",
    q2: "كيف يتم التفويض؟",
    a2: "يتم تفويض الدخول على بعض المنصات التي يمكن التفويض عليها، والمنصات التي لا يمكن التفويض عليها يكون بالتواصل مع المسؤول بالمنشأة لتزويدنا بالرموز عند الدخول الى هذه المنصات",
    q3: "ماذا بعد؟",
    a3: "	تحديد آلية العمل ومتابعته مع صاحب العمل أو إدارة الموارد البشرية وذلك لتحديد أفضل طرق التواصل التي يرغبها العميل مثل (الايميلات – الواتساب – الاتصال – برامج تنظيم المهام مثل Trello او To Do أو Keep أو غيرها، كذلك تحديد طريقة أرشفة العمليات للرجوع لها من قبل العميل في أي وقت سواء في Google Drive  او One Drive أو الايميلات",
